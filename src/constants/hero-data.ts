...
export const HERO_ACCENTS: [HeroAccent, ...HeroAccent[]] = [
...
export const HERO_CLASSES: [HeroClass, ...HeroClass[]] = [
  {
    id: 'scribe',
    name: 'Scribe',
    glyph: '✍',
    ...
    blurb:
      'You wield knowledge like a blade. Writing, reading, and deep reflection are your primary weapons.',
    bias: 'wisdom',
    color: 'amber',
  },
  {
    ...
    blurb:
      'Movement is your meditation. You find clarity through physical challenge and time spent outdoors.',
    bias: 'endurance',
    color: 'jade',
  },
  {
    ...
    blurb:
      'You build worlds with your hands. Every project is a quest, every shipped feature a victory.',
    bias: 'composition',
    color: 'teal',
  },
  {
    ...
    blurb:
      'You guard the equilibrium between effort and rest, between growth and peace. Balance is your strength.',
    bias: 'serenity',
    color: 'aurora',
  },
  {
    ...
    blurb:
      'Every moment is a lesson. You pursue mastery across disciplines and honour the long arc of learning.',
    bias: 'wisdom',
    color: 'crimson',
  },
  {
...
export const HERO_COMPANIONS: [HeroCompanion, ...HeroCompanion[]] = [
  {
    id: 'fox',
    name: 'The Midnight Fox',
    glyph: '🦊',
    blurb:
      'A cunning guide who appears when you are lost. She rewards adaptability and lateral thinking.',
  ...
  },
  {
    ...
    glyph: '🕊',
    blurb:
      'Patient beyond measure. He grants clarity in moments of overwhelm and buffs rest-based recovery.',
  ...
  },
  {
    ...
    glyph: '🐺',
    blurb:
      'She runs alongside you through every early morning. Discipline and endurance are her gifts.',
  ...
  },
  {
    ...
    glyph: '🦉',
    blurb:
      'A scholar of the in-between hours. He watches you study late and amplifies knowledge quests.',
  ...
  },
  {
    ...
    glyph: '🔥',
    blurb:
      'She has seen you fall and rise. Every time you restart after a break, she burns brighter.',
...
export const HERO_RANKS: [HeroRank, ...HeroRank[]] = [
