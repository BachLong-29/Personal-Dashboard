    ...
    <div className={shellOuter}>
      ...
      <header className={topbar}>
        ...
        <div className="flex items-center gap-2 ml-auto">
          ...
          <button type="button" className={forgeBtn} onClick={() => setShowForge(true)}>
            ＋ Forge New Reward
          </button>
        </div>
      </header>
...
const crumb = 'flex items-center gap-1.5 text-[10px] font-[var(--font-title)] tracking-[0.08em]';
...
const shellBody = 'flex flex-1 min-h-0 overflow-hidden';
...
// KPI strip
const kpiRow = 'grid grid-cols-4 gap-3 px-4 py-3 shrink-0 border-b border-[var(--border)]';
const kpiCard =
