...
export const TASK_CAT_MAP = Object.fromEntries(
  TASK_CATEGORIES.map((c) => [c.id, c]),
) as Record<TaskCat, CatMeta>;
...
export const SLOTS: SlotMeta[] = [
  { id: 'morning',   label: 'Dawn',      time: '06–10', glyph: '◐',
    color: 'oklch(0.74 0.17 85)',    bg: 'oklch(0.74 0.17 85 / 0.07)' },
  { id: 'deep',      label: 'Deep Work', time: '10–13', glyph: '❖',
    color: 'oklch(0.66 0.22 295)',   bg: 'oklch(0.66 0.22 295 / 0.07)' },
  { id: 'afternoon', label: 'Afternoon', time: '13–17', glyph: '☉',
    color: 'oklch(0.76 0.16 205)',   bg: 'oklch(0.76 0.16 205 / 0.07)' },
  { id: 'evening',   label: 'Twilight',  time: '17–22', glyph: '☾',
    color: 'oklch(0.72 0.18 5)',     bg: 'oklch(0.72 0.18 5 / 0.07)' },
];
...
export const MOCK_TASKS: UITask[] = [
  // TODAY (day=0)
  {
    id: 'q01', title: 'Plot the Solveig Codex',
    desc: 'Outline the next chapter of the design system — typography, color, motion tokens.',
    cat: 'create', diff: 'S', priority: 'critical', xp: 220, coins: 60, est: 120,
  ...
  {
    id: 'q02', title: 'Morning Sigil Ritual',
    desc: 'Hydrate, stretch, set the day\'s first intention.',
    cat: 'habit', diff: 'C', priority: 'low', xp: 60, coins: 18, est: 15,
    deadline: 'Today · 07:30', deadlineUrgency: 'done',
    progress: 1, subtasks: 4, subtasksDone: 4, day: 0, slot: 'morning',
    tags: ['routine', 'mind'], streak: 14, combo: 3, done: true,
  },
  {
    id: 'q03', title: 'Deep Work — Solo Dungeon',
    desc: 'Two hours sealed off. Phone in the void, deep focus on the spec.',
    cat: 'focus', diff: 'A', priority: 'high', xp: 180, coins: 45, est: 120,
  ...
  {
    id: 'q04', title: 'Mentor Sync · Kai',
    desc: 'Weekly 1:1 with mentor. Bring the three open questions.',
    cat: 'social', diff: 'C', priority: 'medium', xp: 80, coins: 20, est: 30,
  ...
  {
    id: 'q05', title: 'Clear the Inbox Wilds',
    desc: 'Process all messages. Reach inbox zero before the sun sets.',
    cat: 'admin', diff: 'B', priority: 'medium', xp: 90, coins: 25, est: 45,
  ...
  {
    id: 'q06', title: 'Twilight Reflection',
    desc: 'Journal three wins, one lesson, tomorrow\'s pact.',
    cat: 'reflect', diff: 'C', priority: 'low', xp: 70, coins: 18, est: 15,
  ...
  {
    id: 'q07', title: 'Walk the Outer Path',
    desc: '30-minute walk. No earbuds. Notice five textures.',
    cat: 'health', diff: 'D', priority: 'low', xp: 50, coins: 12, est: 30,
  ...
  // REST OF THE WEEK
  {
    id: 'q08', title: 'Forge the Quest Card v3',
    desc: 'Iterate the card layout with the new XP curve.',
    cat: 'create', diff: 'A', priority: 'high', xp: 180, coins: 50, est: 180,
  ...
  {
    id: 'q09', title: 'Strength Trial · Pull Day',
    desc: 'Gym session. Track the lift log.',
    cat: 'health', diff: 'B', priority: 'medium', xp: 100, coins: 24, est: 60,
  ...
  {
    id: 'q10', title: 'Council Sync · Guild',
    desc: 'Standup with the design guild. Demo the new tokens.',
    cat: 'social', diff: 'C', priority: 'medium', xp: 80, coins: 18, est: 45,
  ...
  {
    id: 'q11', title: 'Read · The Lantern Codex (ch 4)',
    desc: '30 pages. Highlight three insights.',
    cat: 'reflect', diff: 'D', priority: 'low', xp: 50, coins: 12, est: 40,
  ...
  {
    id: 'q12', title: 'Trial of the Long Focus',
    desc: '4-hour deep block. No context switching.',
    cat: 'focus', diff: 'S', priority: 'critical', xp: 280, coins: 72, est: 240,
  ...
  {
    id: 'q13', title: 'Ship the Onboarding Flow',
    desc: 'Hand off final screens to engineering.',
    cat: 'create', diff: 'A', priority: 'high', xp: 200, coins: 55, est: 150,
  ...
  {
    id: 'q14', title: 'Forge Tools · Audit Plugins',
    desc: 'Trim the bloated Figma toolbelt. Keep only the worthy.',
    cat: 'admin', diff: 'C', priority: 'low', xp: 60, coins: 15, est: 30,
  ...
  {
    id: 'q15', title: 'Weekly Reflection Rite',
    desc: 'Write the week\'s chapter. Three wins, one trial, next compass.',
    cat: 'reflect', diff: 'B', priority: 'high', xp: 140, coins: 36, est: 45,
  ...
  {
    id: 'q16', title: 'Long Walk — Forest Path',
    desc: '90-minute walk, journal three notes after.',
    cat: 'health', diff: 'C', priority: 'low', xp: 80, coins: 20, est: 90,
  ...
  {
    id: 'q17', title: 'Salon with Mira & Theo',
    desc: 'Dinner. Bring the new sketchbook.',
    cat: 'social', diff: 'D', priority: 'low', xp: 60, coins: 18, est: 180,
  ...
  {
    id: 'q18', title: 'Sabbath · Idle Day',
    desc: 'No quests. Rest is a stat.',
    cat: 'habit', diff: 'D', priority: 'low', xp: 40, coins: 10, est: 480,
  ...
  {
    id: 'q19', title: 'Plan the Week Ahead',
    desc: 'Set the compass: three pillars, one quest line.',
    cat: 'reflect', diff: 'B', priority: 'high', xp: 120, coins: 30, est: 45,
  ...
  // LATER THIS MONTH
  {
    id: 'q20', title: 'Quest Line — Aetheria v2',
    desc: 'Multi-week saga. Ship the entire v2 redesign.',
    cat: 'create', diff: 'S', priority: 'critical', xp: 480, coins: 140, est: 1200,
    deadline: 'May 28', deadlineUrgency: 'month',
    progress: 0.3, subtasks: 12, subtasksDone: 4, day: 14, slot: 'deep',
    tags: ['epic', 'saga'], streak: 0, combo: 0, saga: true,
  },
  {
    id: 'q21', title: 'Public Talk · Local Meetup',
    desc: '20-min talk on gamified productivity.',
    cat: 'social', diff: 'A', priority: 'high', xp: 220, coins: 60, est: 240,
  ...
  {
    id: 'q22', title: 'Pilgrimage · Mountain Day',
    desc: 'Full day hike. No screens.',
    cat: 'health', diff: 'B', priority: 'medium', xp: 180, coins: 50, est: 480,
  ...
  {
    id: 'q23', title: 'Codex Review · v1.2',
    desc: 'Quarterly review of the personal codex.',
    cat: 'reflect', diff: 'A', priority: 'high', xp: 200, coins: 55, est: 90,
