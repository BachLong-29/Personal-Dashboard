        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={cn(
                'rounded-full px-4 py-1.5 font-[var(--f-title)] text-[13px] tracking-[0.1em] uppercase',
      ...
      {tabs.map((tab) => {
        ...
        return (
          <button
            ...
            onClick={() => onChange?.(tab.key)}
            className={cn(
              'relative px-4 py-[9px] font-[var(--f-title)] text-[13px] tracking-[0.12em] font-semibold uppercase',
          ...
          >
            ...
            {active && (
              <span
                className="absolute bottom-[-1px] left-3 right-3 h-0.5 rounded-t bg-[var(--gold)] shadow-[0_0_8px_var(--gold-glow)]"
              />
            )}
          </button>
        );
