...
const variantStyles: Record<BadgeVariant, string> = {
  ...
  violet: 'bg-[oklch(0.68_0.22_295_/_0.12)] text-[var(--violet)] border-[oklch(0.68_0.22_295_/_0.4)]',
  ...
  crimson: 'bg-[oklch(0.62_0.24_22_/_0.12)] text-[var(--crimson)] border-[oklch(0.62_0.24_22_/_0.4)]',
  ...
  return (
    <span
      className={cn(
        ...
        'font-[var(--f-title)] text-[9px] font-bold tracking-[0.18em] uppercase',
