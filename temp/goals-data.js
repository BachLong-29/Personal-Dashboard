// ═══════════════════════════════════════════════════════════════════
// AETHERIA — Ambitions & Glory · mock data
// Goals (Ambitions), Milestones, Achievements (Trophies), Hero stats.
// All exported to window for the React app.
// ═══════════════════════════════════════════════════════════════════

// Categories — each maps to a system color token + currentColor class.
const CATEGORIES = [
  { id: "career",   label: "Career",   color: "gold",   ci: "⚜", desc: "Craft & calling" },
  { id: "health",   label: "Health",   color: "mint",   ci: "❀", desc: "Body & vitality" },
  { id: "learning", label: "Learning", color: "cyan",   ci: "◈", desc: "Skill & study" },
  { id: "finance",  label: "Finance",  color: "violet", ci: "◆", desc: "Wealth & means" },
  { id: "personal", label: "Personal", color: "rose",   ci: "✦", desc: "Self & spirit" },
];

const CAT = Object.fromEntries(CATEGORIES.map(c => [c.id, c]));

const PRIORITIES = {
  high:   { label: "High",   cls: "pri-high",   token: "▲▲▲" },
  medium: { label: "Medium", cls: "pri-medium", token: "▲▲"  },
  low:    { label: "Low",    cls: "pri-low",    token: "▲"   },
};

const STATUSES = {
  "not-started": { label: "Not Started", color: "var(--bg-4)",   swatch: "linear-gradient(135deg, var(--bg-4), var(--bg-3))" },
  "in-progress": { label: "In Progress", color: "var(--cyan)",   swatch: "linear-gradient(135deg, var(--cyan-2), var(--cyan))" },
  "completed":   { label: "Completed",   color: "var(--mint)",   swatch: "linear-gradient(135deg, var(--mint-2), var(--mint))" },
  "archived":    { label: "Archived",    color: "var(--violet)", swatch: "linear-gradient(135deg, oklch(0.4 0.05 295), oklch(0.5 0.06 295))" },
};

const RANK_DESC = { S: "Legendary", A: "Heroic", B: "Skilled", C: "Standard", D: "Apprentice" };

// helper to build milestones
const ms = (...labels) => labels.map((l, i) => ({ id: i + 1, label: l[0], done: l[1] }));
...
const GOALS = [
  {
    ...
    targetDate: "2026-07-15", targetLabel: "Jul 15", created: "Feb 02", daysLeft: 31,
  ...
  },
  {
    ...
    targetDate: "2026-09-20", targetLabel: "Sep 20", created: "Mar 10", daysLeft: 98,
  ...
  },
  {
    ...
    targetDate: "2026-12-05", targetLabel: "Dec 05", created: "Jan 15", daysLeft: 174,
  ...
  },
  {
    ...
    targetDate: "2026-08-01", targetLabel: "Aug 01", created: "Nov 20", daysLeft: 48,
  ...
  },
  {
    ...
    targetDate: "2026-11-01", targetLabel: "Nov 01", created: "Apr 01", daysLeft: 140,
  ...
  },
  {
    ...
    targetDate: "2026-10-10", targetLabel: "Oct 10", created: "Jun 01", daysLeft: 118,
  ...
  },
  {
    ...
    targetDate: "2026-07-28", targetLabel: "Jul 28", created: "Apr 19", daysLeft: 44,
  ...
  },
  {
    ...
    targetDate: "2026-12-31", targetLabel: "Dec 31", created: "Jan 01", daysLeft: 200,
  ...
  // ── COMPLETED ──
  {
    ...
    targetDate: "2026-05-01", targetLabel: "May 01", created: "Dec 01", daysLeft: 0, completedDate: "Apr 28",
  ...
  },
  {
    ...
    targetDate: "2026-04-10", targetLabel: "Apr 10", created: "Mar 11", daysLeft: 0, completedDate: "Apr 10",
  ...
  },
  {
    ...
    targetDate: "2026-03-22", targetLabel: "Mar 22", created: "Jan 05", daysLeft: 0, completedDate: "Mar 22",
  ...
  // ── ARCHIVED ──
  {
    ...
    targetDate: "2026-06-01", targetLabel: "Jun 01", created: "Jan 20", daysLeft: 0,
...
// ────────────────────────────────────────────────────────────
const HERO = {
  name: "Aria Solveig", initials: "AS", title: "Shadow Weaver · Lv 24",
  level: 24, coins: 248, gems: 132,
  streak: 12, bestStreak: 28,
  weekDots: [1, 1, 1, 1, 1, 0, 0], // mon..sun completed
  todayIdx: 4,
};

// Motivational lines (rotates)
const MOTIV_LINES = [
...
Object.assign(window, { CATEGORIES, CAT, PRIORITIES, STATUSES, RANK_DESC, GOALS, TROPHIES, HERO, MOTIV_LINES });
